...
data.work_exp.forEach(function (item, idx){
    var logo = '<div class="card_logo_box">';
    logo += '<div class="card_logo">';
    logo += '<img src="icons/logos/' + item.logo + '">';
    logo += '</div>';
    ...
    $('#work_exp').find('.timeline_list').append(content);
});

data.credentials.forEach(function (item, idx){
    var logo = '<div class="card_logo_box">';
    logo += '<div class="card_logo">';
    // logo += '<img src="icons/logos/' + item.logo + '">';
    logo += idx + 1;
    ...
    $('#credentials').find('.timeline_list').append(content);
}); 